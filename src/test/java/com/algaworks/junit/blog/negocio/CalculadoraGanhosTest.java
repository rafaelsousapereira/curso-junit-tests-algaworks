...
class CalculadoraGanhosTest {
    ...
    @BeforeEach
    void beforeEach() {
        autor = new Editor(1L, "Rafael", "rafael@gmail.com", new BigDecimal(5), true);
    ...
    @Test
    void Dado_um_post_e_autor_Quando_calcular_ganhos_Entao_deve_retornar_valor_pago_por_palavras_do_autor() {
        Ganhos ganhos = calculadora.calcular(post);
